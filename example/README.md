# Book Club API
Welcome to the Book Club API! This Phoenix web application provides a public API to access information about the books in our collection and track their reading progress.
